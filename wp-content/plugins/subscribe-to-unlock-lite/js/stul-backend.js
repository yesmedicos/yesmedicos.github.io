jQuery(document).ready(function ($) {
    ...
    $('body').on('click', '.stul-nav-item', function () {
        ...
        if (tab == 'upgrade') {
            $('.stu-shortcode-info').hide();
        } else {
            $('.stu-shortcode-info').show();
        }
    ...
    $(".stul-compare-click").click(function () {
        $(".stul-compare-panel").toggle();
        $(".stul-wrap").toggleClass("stul-compare-overlay");
    });
    $(".close-panel").click(function () {
        $(".stul-compare-panel").hide();
        $(".stul-wrap").removeClass("stul-compare-overlay");
    });
